...
export const shops: Shop[] = [
  {
    ...
    name: 'パティスリー　ジョリクレール',
    description:
      '当店は雄大な自然が広がる「北海道・北斗市」にある洋菓子専門店です。パティシエ自慢の季節感・旬感を大事にした創作スイーツを多数取り揃えております。',
    area: '函館市近郊エリア',
    postcode: '049-0162',
    address: '北斗市中央2-1-5',
  ...
  },
  {
    ...
    name: 'たいやき茶屋　北菓り',
    description:
      '函館朝市内にある、たいやき店。生地の美味しさにこだわり、ハネ付きに仕上げています。定番の甘さ控えめの粒あん等のほか、北海道産のリンゴやじゃがいもを使ったオリジナルのたい焼きが人気です。',
    area: '西部エリア',
    postcode: '040-0063',
  ...
  },
  {
    ...
    name: 'ラパン・ド・ネージュ',
    description:
      'シェフが一人で全てのケーキを作る小さなお店です。道産素材を中心に、こだわりの食材や季節のおいしい果物など旬を大切にていねいなお菓子を作っています。',
    area: '西部エリア',
    postcode: '040-0064',
    address: '函舘市大手町16-1',
  ...
  },
  {
    ...
    description:
      '今までにない味と食感を追究して作り上げたロールケーキ。定番の5種と季節商品2種が毎月発売され、イベント月には限定商品等年間30種類以上の品揃えがあります。ｌ',
    area: '中央エリア',
    postcode: '040-0073',
  ...
  },
  {
    ...
    name: 'ボン・ガトー・マリス',
    description:
      '気軽にケーキ１つから買いに来ていただけるような親しみやすいお店を目指しています。大切な日の、笑顔になるお手伝いが出来ればと思います。',
    area: '中央エリア',
    postcode: '040-0082',
    address: '函館市白鳥町2-7',
  ...
  },
  {
    ...
    name: 'チッチョ　パスティッチョ',
    description:
      'オーナーシェフが現地で学び、食べ歩いたイタリア北部・中部の伝統菓子や郷土菓子をベースにした愛らしいドルチェが並ぶ。ケーキやプリンなどの生菓子の他、クッキーやマカロンなどの焼き菓子も提供しております。',
    area: '北部エリア',
    postcode: '041-0802',
    address: '函館市石川町316-5',
  ...
  },
  {
    ...
    name: 'キングベーク',
    description:
      '昭和4年創業の老舗ベーカリー。道産小麦やバターなど原材料にこだわり、安心・安全な商品作りがモットー。焼きたてパンやケーキ・プリン等のスイーツを販売する他、併設のカフェスペースで軽食も楽しめる。',
    area: '北部エリア',
    postcode: '041-0813',
    address: '函館市亀田本町7-8',
  ...
  },
  {
    ...
    description:
      '平成28年3月の新幹線開業に合わせてオープンしたヨシダのお菓子本店「和創菓ひとひら」です。工場併設店舗ならではの、こだわりのお菓子と店内でお菓子を楽しめるイートインコーナーもあります。',
    area: '北部エリア',
    postcode: '041-0824',
  ...
  },
  {
    ...
    name: '北洋堂',
    description:
      '桜とお城の松前町の中央商店街「城下通り」登城坂の近くにあり、瓦屋根に漆喰壁と江戸時代の商家を連想させる佇まいのお菓子屋です。代々引き継がれた和菓子を中心に季節のお菓子が並べられ、桜を使ったお菓子もたくさん取り揃えております。',
    area: '函館市近郊エリア',
    postcode: '049-1511',
  ...
  },
  {
    ...
    name: 'いなふね菓子舗',
    description:
      'お餅からあられまで、和菓子各種がバラエティに揃う。手づくりのあんこが、甘すぎず美味しい。よもぎを使った和菓子が人気で、特に、よもぎまふぃん、よもぎのべこ餅は好評です。',
    area: '東央エリア',
    postcode: '041-0843',
    address: '函館市花園町37-34',
    openingHoursSpecification: '9:00～19:00',
  ...
  },
  {
    ...
    name: '菓子工房　花園正家',
    description:
      'ほんものの、心を贈る手造りの店。当社は昭和48年創業の和菓子専門店です。近年は特に、健康第一が叫ばれている時代。当店では道産健康食材を取り入れた、銘菓開発に力を注いでおります。是非ご賞味下されば幸いと存じます。',
    area: '北部エリア',
    postcode: '041-0802',
  ...
  },
  {
    ...
    description:
      'レストラン五島軒は明治12年に創業し、函館の歴史と洋食文化を今に伝える老舗として、市民の皆様に親しまれてきました。店内の直営ショップ「Ashibino」は、コース料理のデザートとして発展した洋菓子の数々を取り揃え、お客様をお待ちしております。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町4-5',
  ...
  {
    id: 31,
    name: '函館国際ホテル東館１階 Le HAVRE',
    description:
      '開放感のある落ち着いたティーラウンジ。待ち合わせなどに最適な座り心地のよいソファーとゆとりのスペースが魅力です。パティシエが作るケーキはイートインもテイクアウトもできます。',
    area: '西部エリア',
    postcode: '040-0064',
    address: '函館市大手町5-10',
    ...
    imagePath: 'http://www.hakodate-sweets.com/pgm/img/main01-20181214011637.jpg',
    telephone: '0138-23-8755',
    created_at: '2020-01-06T06:48:49.000Z',
    updated_at: '2020-01-06T06:48:49.000Z',
  },
  {
    ...
    description:
      '函館五稜郭の近郊にお店を構える道内屈指のチョコレート専門店。ケーキや焼き菓子、アイスクリームなど、たくさんのお菓子を取り揃えて皆様をお迎えします。',
    area: '中央エリア',
    postcode: '040-0015',
    address: '函館市梁川町27-16',
    openingHoursSpecification: '10:00～20:00',
  ...
  },
  {
    ...
    name: '八雲　くら屋',
    description:
      'お菓子を通してお客様と喜びを分かち合うお店。1969年に創業。お菓子を一生懸命、造り販売してまいりました。従業員一同心よりお待ちしております。',
    area: '函館市近郊エリア',
    postcode: '049-3105',
  ...
  },
  {
    ...
    description:
      '1977年創業以来、素材にこだわり愛情をこめて全て手作りしております。お気に入りの写真やキャラクターをケーキにして大切な日を記憶に残る日にしませんか？当店では100％オーダーメイドのデコレーションケーキができます。何でもご相談ください！！※写真はイメージです。',
    area: '北部エリア',
    postcode: '041-0802',
  ...
  },
  {
    ...
    description:
      'ケーキはできるだけ添加物を使わず出来たてをお客様にと思っています。ケーキ、喫茶、誰かと楽しみいっぱいの品をそろえています。',
    area: '中央エリア',
    postcode: '040-0062',
    address: '函館市大縄町24-16',
  ...
  },
  {
    ...
    eatin: 'なし',
    email: 'なし',
    url: 'http://patisserie-baigetsu.jp/',
    latitude: '41.823292',
  ...
  },
  {
    ...
    description:
      'シーズン毎に様変わりする花と緑のパティオから差し込む穏やかな陽の光の中で、心おだやかに、できたてのケーキをお楽しみ下さい。',
    area: '中央エリア',
    postcode: '042-0943',
    address: '函館市乃木町1-2',
    openingHoursSpecification: '10:00～19:00',
  ...
  },
  {
    ...
    name: 'パティスリー　イグレック',
    description:
      '東京やフランスで修行した静岡出身の女性オーナーパティシエが作るスイーツのお店。季節のフルーツがどっさりのったフルーツタルトや、写真やキャラクターを使ったフォトケーキは、お誕生日や記念日に人気。',
    area: '函館市近郊エリア',
    postcode: '049-0121',
  ...
  },
  {
    ...
    name: '函館おたふく堂',
    description:
      '北海道産大豆から出来た、豆乳、おから、豆腐を道産小麦粉、道産グラニュー糖、道南の旬の食材を使用した、豆乳しふぉんケーキ専門店です。他にも、おからボーロ、とうふケーキなどの品揃えをしています。',
    area: '北部エリア',
    postcode: '041-0853',
  ...
  },
  {
    ...
    name: '菓匠　一福',
    description:
      '焼き菓子や羊羹、上生菓子からロールケーキまで和洋の商品を取り揃えております。中華まんじゅう、どら焼き、あきあじ最中などが人気です。創業は100年になります。',
    area: '函館市近郊エリア',
    postcode: '049-0281',
  ...
  },
  {
    ...
    description:
      '1947年創業のアイスクリーム＆シャーベット専門店。北海道の新鮮な牛乳、生クリーム、天然の素材を基本に作られています。容器はシンプルに、素材にこだわったアイスクリームです。',
    area: '西部エリア',
    postcode: '040-0034',
    address: '函館市大森町18-15',
  ...
  },
  {
    ...
    description:
      '函館山の麓。観光地ベイエリア近くにあるシュークリームの専門店ママデコレ。お土産にも、旅の途中の食べ歩きにも。おひとついかがですか。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町16-10',
    openingHoursSpecification: '10:00～18:00',
  ...
  },
  {
    ...
    name: '山田屋菓子舗',
    description:
      'お店手づくりの和菓子は、一つひとつ丁寧に作っております。かもめ島最中や大福餅など、さまざまな和菓子が揃う。中でもいちご大福は遠方から訪れてくれるファンも多い人気商品です。',
    area: '函館市近郊エリア',
    postcode: '043-0041',
  ...
  },
  {
    ...
    name: 'キングスイーツ',
    description:
      '地元の老舗ベーカリー「キングベーク」直営のスイーツ専門店。オリジナルソフトクリームやお土産に最適な商品が並ぶ。人気商品「函館ラスク」は試食が可能な他、チョコレート掛けを見学できる実演スペースも併設。',
    area: '西部エリア',
    postcode: '040-0063',
  ...
  },
  {
    ...
    name: 'アンジェリックヴォヤージュ',
    description:
      '函館の港と夜景が見える小さなお店で、楽しくお菓子を作っています。当店のスペシャル、ショコラヴォヤージュをはじめ、お土産に最適な焼菓子も取り揃えています。ご注文を受けてからお作りするクレープもオススメ！',
    area: '西部エリア',
    postcode: '040-0056',
    address: '函館市弥生町3-11',
  ...
  },
  {
    ...
    description:
      '金森赤レンガ倉庫群そばの海上レストラン。海の景色がご馳走、ゆったりゆっくり154席。お客様においしく・楽しい・幸せな一時を過ごしていただくことを願っております。※ラッキーピエロは函館市内、近郊13店舗。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町14-17',
  ...
  },
  {
    ...
    description:
      '昭和21年、函館駅前大門地区に鈴木商店直営の喫茶店を開業。店名を函館市民から一般公募し、美鈴と命名。美鈴直営店第1号店。',
    area: '西部エリア',
    postcode: '040-0035',
    address: '函館市松風町7-1',
  ...
  },
  {
    ...
    name: '御菓子処　ひとつ風',
    description:
      '杉並電停から徒歩1分電車道路沿いにあります。地産地消を心掛け季節を感じて頂ける様な菓子を御用意しております。季節行事の楽しい物もございます。特別注文も気軽に御相談下さい。',
    area: '中央エリア',
    postcode: '040-0003',
    address: '函館市松陰町8-1',
  ...
  },
  {
    ...
    name: '元祖　大沼だんご　沼の家',
    description:
      '明治38年、初代堀口亀吉が「大沼だんご」を製造販売致しました。以来、大沼公園と大沼だんごは100余年の歳月を多くの人々に親しまれてまいりました。',
    area: '函館市近郊エリア',
    postcode: '041-1354',
  ...
  },
  {
    ...
    name: 'はこだて甘納豆　石黒商店',
    description:
      '函館唯一の甘納豆製造販売店です。着色料、保存料を使用せず甘さも抑えてますので賞味期限は14日と短めですが11種類それぞれの風味の違いを感じられます。他にゆきうさぎモナカ、花み餅等もございます。',
    area: '北部エリア',
    postcode: '041-0812',
    address: '函館市昭和2-11-2',
  ...
  },
  {
    ...
    name: '函館酪農公社　あいす１１８',
    description:
      '函館牛乳の工場敷地内にあるキャンピングカーの小さなお店、あいす１１８では、牛乳本来の味、栄養をそこなわないように、必要最小限しか手を加えていないソフトクリームやチーズなどの乳製品を直売しています。',
    area: '東央エリア',
    postcode: '042-0912',
    address: '函館市中野町118-17',
    openingHoursSpecification:
      '（4、10月）9:30～17:00（5、6、9月）9:00～17:00（7、8月）9:00～18:00（冬期）10:00～16:00',
  ...
  },
  {
    ...
    name: '焼き菓子の店　morico',
    description:
      '小さなお店で焼き菓子、タルト、スコーン、キッシュなどを焼いています。季節のコンフィチュールもあります。',
    area: '中央エリア',
    postcode: '040-0011',
    address: '函館市本町35-9',
  ...
  },
  {
    ...
    description:
      '今までにない味と食感を追究して作り上げたロールケーキ。定番の5種と季節商品2酒が毎月発売されイベント月には限定商品等年間30種類以上の品揃えがあります。ロールケーキの素材で焼き上げた「函館窯出しドーナツ」「デュオショコラ」等、焼菓子も充実しています。',
    area: '西部エリア',
    postcode: '040-0063',
    address: '函館市若松町12-13JR函館駅構内1階',
    openingHoursSpecification: '8:00～20:00',
  ...
  },
  {
    ...
    name: '四季の洋菓子　キャトルセゾン',
    description:
      '自然に囲まれた工房で無添加原料を使用し、昔からあるアンティークなケーキをつくっているお店です。1番人気の『シュークリーム』をはじめ、約15種類のケーキと焼き菓子をご用意しております。',
    area: '函館市近郊エリア',
    postcode: '041-1111',
  ...
  },
  {
    ...
    name: 'お菓子工房　レーヴモンブラン',
    description:
      '道内各地で修行をして夢だった洋菓子店を平成28年10月にオープンしました。ケーキは約20種類、マドレーヌなどの焼き菓子は約15種類ご用意して皆様のお越しをお待ちしております。',
    area: '北部エリア',
    postcode: '041-0822',
    address: '函館市亀田港町63-6',
    openingHoursSpecification: '10:00～19:00',
  ...
  },
  {
    ...
    name: '浅野屋',
    description:
      '浅野屋は大正12年（1923年）に創業しました。「江差の繁次郎」や「瓶子岩最中」などお土産の和菓子をはじめ、洋菓子も取り揃えております。',
    area: '函館市近郊エリア',
    postcode: '043-0043',
    address: '檜山郡江差町字本町45',
    openingHoursSpecification: '10:00～19:00',
  ...
  {
    id: 69,
    name: '五島軒　十字街プロミエルカモイ店',
    description:
      'レストラン五島軒は明治１２年に創業し、函館の歴史と洋食文化を今に伝える老舗として、市民の皆様に親しまれてきました。十字街店は、五島軒の直営売店として、生ケーキを中心に各種スイーツ、レトルト・缶詰カレーなどのデリカ商品、ハム・ソーセージ、ブレンドコーヒー、パン、アイスクリームなど、五島軒の扱うあらゆる商品を取り揃えております。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町5-20',
    openingHoursSpecification: '10:00～19:00',
    ...
    url: 'なし',
    latitude: '41.763472',
    longitude: '140.718792',
    imagePath: 'http://www.hakodate-sweets.com/pgm/img/main01-20181211034622.jpg',
    telephone: '0138-23-3560',
    created_at: '2020-01-06T06:48:50.000Z',
    updated_at: '2020-01-06T06:48:50.000Z',
  },
  {
    ...
    description:
      'ベイエリアの佇まいの中に愛嬌たっぷりのピエロくんがお出迎え。ここがラッキーピエロの１号店です。森の中にいるような店内にあるブランコの席や木馬。きっと幼い頃を想い出し懐かしく楽しいひとときになるでしょう。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町23-18',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　港北大前店',
    description:
      '１９５０年代のアメリカを思わせる店。プレスリーが青春だった「ラッキーピエロ　港北大前店」です。アンティークな雰囲気の店内で出逢うのは最高の味！',
    area: '北部エリア',
    postcode: '041-0821',
  ...
  },
  {
    ...
    description:
      '毎日がハッピーなお店、サンタが函館にやってきた。歴史ある街並みの中にあって、歴風文化賞を受賞。建物の中にはクリスマスグッズの数々や、流れるメロディーもクリスマス一色。２階席への階段を上がるとそこはまるで夢の世界。',
    area: '西部エリア',
    postcode: '040-0053',
    address: '函館市末広町8-11',
    openingHoursSpecification: '10:00～24:30(土曜日のみ 25:30まで)  ',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　松陰店',
    description:
      '街の中にあるジャングルです。アンリ・ルソーの名画、熱帯の原始林をイメージした店内は自然の中にいるような開放感と明るい雰囲気が漂っています。',
    area: '中央エリア',
    postcode: '040-0003',
    address: '函館市松陰町22-6',
    openingHoursSpecification: '10:00～24:30(土曜日のみ 25:30まで)  ',
  ...
  },
  {
    ...
    description:
      'ゆったり５４席の五稜郭公園前店は天使が微笑む店です。広々とした空間は天使達の優しさに包まれ、心が和む時を過ごせることでしょう。ほら、天使のおしゃべりが聞こえてきませんか？',
    area: '中央エリア',
    postcode: '040-0001',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　人見店',
    description:
      '店内にはたくさんの花・花・花…。天井には素敵なぶどう棚。ラッキーピエロの中で唯一大人気のあんかけ焼きそば＆ラーメンが食べられるお店です。',
    area: '中央エリア',
    postcode: '040-0005',
    address: '函館市人見町24-15',
    openingHoursSpecification: '10:00～24:30(土曜日のみ25:30まで)',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　本町店',
    description:
      'ラッキーピエロの新たな伝説が始まるクリムトハウス。グスタフ・クリムトの絵画と白黒を基調にした店内は、シックな大人の雰囲気となっています。',
    area: '中央エリア',
    postcode: '040-0011',
    address: '函館市本町4-18',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　美原店',
    description:
      '銀幕の映画スターたちが函館に大集合!?色んな映画ポスターが店内の壁に所狭しと並んでいます。青春時代をゆっくりと味わえるようなお店です。',
    area: '北部エリア',
    postcode: '041-0806',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　函館駅前店',
    description:
      '今までにない紺色を基調にした店作りに、天井や壁一面にアールデコ調のポスターでおしゃれに店内を演出しています。JR函館駅から一番近いお店です。',
    area: '西部エリア',
    postcode: '040-0063',
    address: '函館市若松町17-12',
    openingHoursSpecification: '10:00～24:30(土曜日のみ 25:30まで)  ',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　本通店',
    description:
      '総天然色の食欲満開！映画のワンシーンに登場するようなムーディーな店内で、有名な「ボッティチェリ」をテーマにした魅惑の空間のお店です。',
    area: '北部エリア',
    postcode: '041-0851',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　昭和店',
    description:
      '８０年代前半、函館の街を一世風靡した大門の人気スポット「テニスレディ」の復刻版的１軒です。もちろん若い人達にとっても楽しさいっぱいのお店です。',
    area: '北部エリア',
    postcode: '041-0812',
  ...
  },
  {
    ...
    name: 'ラッキーピエロ　戸倉店',
    description:
      '聖堂を思わせる建物の側で風車が風の音を奏でている。壁には額縁に入った１５０枚の写真が飾られ、まさにここはハンバーガー博物館。函館空港から一番近いお店です。',
    area: '東央エリア',
    postcode: '042-0953',
    address: '函館市戸倉町30-1',
    openingHoursSpecification: '10:00～24:30(土曜日のみ 25:30まで) ',
